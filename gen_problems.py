...
import pandas as pd
from get_arguments import get_suffix_modified, args, get_version_dir
...
if args.synthetic:
	...
	if args.customalphabet is not None:
		letters = args.customalphabet.split()
	else:
...
def main(args):
	...
	# Convert to json strings and write to json
